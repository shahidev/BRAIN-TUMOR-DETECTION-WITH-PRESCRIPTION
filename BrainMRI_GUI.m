%Project Title: Brain Tumor Segmentation & Classification using MRI
...
load Trainset.mat
 ...
 if strcmpi(species,'MALIGNANT')
     ...
     disp('Medications');
     disp('chemotherapy , anti-convulsent drugs,Steroid Therapy, anti-emetic ,pain killers');
     
     disp('Surgery');
     disp('craniotomy');
     
     disp('Medical procedure');
     disp('tomo therapy and radiation therapy');
 else
     helpdlg(' Benign Tumor ');
     disp(' Benign Tumor ');
    
     disp('TUMOR TYPE TREATMENT');
     disp('BAIN TUMOR SURGERY (Craniotomy), Radio therapy ,CHEMO Therapy , ANTI -convulsants , Steroids, Pain killers,anti-emepics ');
 end
